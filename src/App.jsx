	...
	return (
		<div className="bg-gray-50 text-gray-900 h-screen antialiased flex flex-col overflow-hidden relative">
			...
			<button
				...
				className="js-library-toggle fixed left-6 bottom-6 z-40 p-3 bg-blue-600 hover:bg-blue-700 text-white rounded-full shadow-lg transition-transform hover:scale-110 flex items-center gap-2 group"
